...
import 'package:ball/model/products.dart';
import 'package:ball/screen/collection.dart';
import 'package:ball/screen/h.dart';
import 'package:ball/screen/profile.dart';
...
اليوم : 445456456456456
 ''';
  ...
  List<Widget> Screens = [const h(), const collection(), profile()];
  List<String> Title = [
    'الرئيسيه',
    'فواتيرك',
    'البروفايل',
  ...
  void pro_edit({required String model}) {
    ...
    for (var element in dynamicMapFromJson) {
